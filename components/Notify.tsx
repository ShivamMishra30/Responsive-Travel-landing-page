...
function Notify() {
  return (
    <div className="mx-auto my-20 flex h-auto w-11/12 flex-col items-center justify-center rounded-md bg-sky-400 p-8 shadow-xl">
      ...
      <button className="h-14 rounded-md border border-white px-10 text-xl text-white hover:border-none hover:bg-sky-500 ">
        Register
      </button>
    </div>
  )
