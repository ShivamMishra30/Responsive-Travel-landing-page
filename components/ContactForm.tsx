...
function ContactPage() {
  return (
    <div className="bg-[#3AB0FF] w-screen pb-10 h-auto">
      <div className="flex justify-around items-center mx-10 md:flex-row pt-10 flex-col">
        {/* textual content */}
        <div className="md:w-1/2 w-full md:pt-10 my-10 md:my-0  flex-col">
